    ...
    <div class="header">
      <div class="header-left">
        <div class="logo">
          ...
          <div class="logo-text">
            <span class="logo-title">小区停车场管理系统</span>
            <span class="logo-subtitle">Parking Lot Management</span>
          </div>
        </div>
      </div>
    ...
    <div class="main-container">
      ...
      <div class="sidebar">
        ...
        >
          ...
          <el-menu-item index="/system/device" class="menu-item">
            <el-icon class="menu-icon"><Grid /></el-icon>
            <span>车场设备管理</span>
          </el-menu-item>
          <el-menu-item index="/system/order" class="menu-item">
            <el-icon class="menu-icon"><Document /></el-icon>
            <span>停车记录管理</span>
          </el-menu-item>
          <el-menu-item index="/system/parking-simulate" class="menu-item">
            <svg class="menu-icon-svg" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg">
              <path d="M779.93984 119.82848H422.7072l-178.62656 402.16576h154.23488l-109.568 397.23008 446.5664-479.06816h-163.77856L779.93984 119.82848z m0 0" fill="#94a3b8"/>
            </svg>
            <span>模拟停车登记</span>
          </el-menu-item>
        </el-menu>
...
import { User, Grid, Document, ArrowDown, Setting, SwitchButton } from '@element-plus/icons-vue'
...
@keyframes logoPulse {
  0%, 100% { box-shadow: 0 8px 24px rgba($primary-color, 0.3); }
  50% { box-shadow: 0 8px 32px rgba($primary-color, 0.45); }
}
